...
namespace raj {
 ...
 // declaration of the structure data type
 // use struct keyword then name_of_structure then braces
 // at last end the braces by semicolon 
struct node {
	string str; 
	int num;
	double doub; 
	...
	// constructor -> automatically call when any object
	// 				  is made of the structure
...
int main() {
	...
	// outside the main or globaly 10^7
	int arr[1000000]; 
	...
	// create a data type where you store all these 
	// So the Structure come's which is user define 
	// data type.
	...
	// instead of this you could make constructor 
	// by which assigning the value as with create an object 
	...
	// bitset used in the segment tree  
